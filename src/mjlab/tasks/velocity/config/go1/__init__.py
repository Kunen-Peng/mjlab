...
from .env_cfgs import (
  ...
  unitree_go1_rough_warp_ray_env_cfg,
)
...
register_mjlab_task(
  task_id="Mjlab-Velocity-Rough-Unitree-Go1-Warp-Ray",
  env_cfg=unitree_go1_rough_warp_ray_env_cfg(),
  play_env_cfg=unitree_go1_rough_warp_ray_env_cfg(play=True),
  rl_cfg=unitree_go1_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
